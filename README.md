...
<p align="left">
  <ul>
    ...
    <li>Go to "Addons"</li>
    <li>In Addons, install an addon from zip.  When it asks for the location, select "Twilight0 Repo", and install <a href="repository.twilight0-1.4.zip">repository.twilight0.zip</a>.</li>
