...
<p align="left">
  <ul>
    ...
    <li>Go to "Addons"</li>
    <li>In Addons, install an addon from zip.  When it asks for the location, select "Twilight0 Repo", and install <a href="_zips/repository.twilight0/repository.twilight0-1.3.zip">repository.twilight0-1.3.zip</a>.</li>
